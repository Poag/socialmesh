...
class NodeStorageService {
  ...
  Map<String, dynamic> _nodeToJson(MeshNode node) {
    return {
      ...
      'envDistance': node.envDistance,
      'envCurrent': node.envCurrent,
      'envVoltage': node.envVoltage,
      // Power Metrics
      ...
      'co2': node.co2,
      // Local Stats
      'numPacketsTx': node.numPacketsTx,
      'numPacketsRx': node.numPacketsRx,
      'numPacketsRxBad': node.numPacketsRxBad,
      'numOnlineNodes': node.numOnlineNodes,
      'numTotalNodes': node.numTotalNodes,
      'numTxDropped': node.numTxDropped,
      'noiseFloor': node.noiseFloor,
      // Node Status
      'nodeStatus': node.nodeStatus,
      // Traffic Management Stats
      'tmPacketsInspected': node.tmPacketsInspected,
      'tmPositionDedupDrops': node.tmPositionDedupDrops,
      'tmNodeinfoCacheHits': node.tmNodeinfoCacheHits,
      'tmRateLimitDrops': node.tmRateLimitDrops,
      'tmUnknownPacketDrops': node.tmUnknownPacketDrops,
      'tmHopExhaustedPackets': node.tmHopExhaustedPackets,
      'tmRouterHopsPreserved': node.tmRouterHopsPreserved,
      ...
      'positionTimestamp': node.positionTimestamp?.millisecondsSinceEpoch,
      // Connectivity
  ...
  MeshNode _nodeFromJson(Map<String, dynamic> json) {
    ...
    return MeshNode(
      ...
      envDistance: (json['envDistance'] as num?)?.toDouble(),
      envCurrent: (json['envCurrent'] as num?)?.toDouble(),
      envVoltage: (json['envVoltage'] as num?)?.toDouble(),
      // Power Metrics
      ...
      co2: json['co2'] as int?,
      // Local Stats
      numPacketsTx: json['numPacketsTx'] as int?,
      numPacketsRx: json['numPacketsRx'] as int?,
      numPacketsRxBad: json['numPacketsRxBad'] as int?,
      numOnlineNodes: json['numOnlineNodes'] as int?,
      numTotalNodes: json['numTotalNodes'] as int?,
      ...
      tmNodeinfoCacheHits: json['tmNodeinfoCacheHits'] as int?,
      tmRateLimitDrops: json['tmRateLimitDrops'] as int?,
      tmUnknownPacketDrops: json['tmUnknownPacketDrops'] as int?,
      tmHopExhaustedPackets: json['tmHopExhaustedPackets'] as int?,
      tmRouterHopsPreserved: json['tmRouterHopsPreserved'] as int?,
      // GPS/Position Extended Fields
      ...
      groundTrack: (json['groundTrack'] as num?)?.toDouble(),
      precisionBits: json['precisionBits'] as int?,
      positionTimestamp: json['positionTimestamp'] != null
          ? DateTime.fromMillisecondsSinceEpoch(
              json['positionTimestamp'] as int,
            )
          : null,
      // Connectivity
